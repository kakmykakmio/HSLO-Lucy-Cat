...
var plzdontstealmycode_19323 = ['cellsTab2', 'cellsTab3', 'cellsIDTab1', 'cellsIDTab2', 'myCellsTab1', 'myCellsTab2', 'myCellsTab3', 'bound', 'bound2', 'sortedCells', 'forEach', 'updateStaticBound', 'fadeStartTime', 'teste1', 'isInView', 'isFood', 'isVirus', 'segregator', 'teste2', 'isMine', 'isInView2', 'teste3', 'isInView3', 'animRadius', 'getCell', 'addCell', 'myCellCheck', 'cellsIDTab3', 'eatCell', 'staticX', 'staticY', ':removed', 'tab', 'radius', 'classI', 'isEjected', 'isFriend', 'account', 'animX', 'animY', '_000308', '_000307', 'staticMass', 'isUnnamed', '_nick', '_nick2', '_skin', '_skin2', '_tag', 'colorHexTab1', 'colorHexTab2', 'mass2', 'controlledTab', 'pieceCount', 'playing', 'playing2', 'updateData', 'sendAliveData', 'colorObject', 'commanderPoints', 'playerData', 'pieceCount2', 'sqrt', 'pow', 'autoZoomViewport', 'dead', 'dead2', 'invalidSkinUrl', 'join', '_colorObject', 'location', 'classA', 'isNew', 'isRGB', 'timeStamp', 'cacheIndicator', 'middle', '600 150px FontAwesome', 'fillText', 'crossOrigin', 'anonymous', 'edge', 'offset2', 'Tab2LT', 'Tab3LT', 'center2', 'focusedAtCenter', 'updateOffset2', 'updateOffset3', 'center3', 'Tab3Viewport', 'Tab3ViewBounds', '_freeSpectate', 'updateView', 'move', 'spectatePoints', '_isSpectating', 'maxCacheLife', 'nickShadowCtx', 'newShadowContext', 'canvasPool', 'newNickCache', 'level', 'getNewCanvas', 'quality', 'getNickWidth', '700 ', 'px ', 'strokeText', 'performance', 'measureText', '700 25px ', 'newMassCache', 'lastUsedAt', 'fontSize', 'needsRedraw', 'getMassWidth', 'massShadowCtx', 'setMassCtxFont', 'getScreenRadius', 'isSmall', '700 25px ubuntu', 'cleaner', 'resetCanvas', '_mass', '_fontSize', 'rainbow', 'cacheCanvas', 'cacheCtx', 'shadowBlur', 'strength', 'isGlowOn', 'restore', 'drawImage', 'smaller', 'same', 'biggerSTE', 'bigger', 'renderGroup', '#2196F3', '#FF9800', '#FD0000', 'viruses', 'skinMap', 'https://i.imgur.com/O5k0G4p.png', 'getCustomSkin', 'downloadedSkins', 'downloadSkin', 'onload', 'clip', 'toDataURL', 'https://i.imgur.com/', '.png', 'sectorEdge', 'halfSectorEdge', 'letters', 'visible', 'fantasy', 'sectors', 'onlyLines', 'updateViewSectors', 'rect', '400 ', 'cellCount', 'getDistanceSquare', 'target_unnamed', 'dataView', 'index', 'maxIndex', 'byteLength', 'getUint8', 'readInt8', 'getInt8', 'readUInt16', 'getUint16', 'getInt16', 'readUInt32', 'getUint32', 'readInt32', 'getInt32', 'readFloat32', 'getFloat32', 'readFloat64', 'getFloat64', 'readUTF8string', 'endOfBuffer', 'readUTF16string', 'readEscapedUTF8string', 'decompress', 'buffer', 'decodeBlock', 'arrayBuffer', 'writeInt8', 'value out of range [Min: -128, Max: 127, Value: ', 'writeUint16', 'value out of range [Min: 0, Max: 65535, Value: ', 'writeInt16', 'value out of range [Min: -32768, Max: 32767, Value: ', 'value out of range [Min: 0, Max: 4294967295, Value: ', 'writeInt32', 'writeString', 'writeUint8', 'writeEncodedString', 'writeUTF16String', 'writeUTF16StringNonZero', 'Tab1', 'connectedTab1', 'connectedTab2', 'Tab3', 'ipBox', '#ip-box', 'disconnect', 'resetData', 'onopen', 'Tab1WS', 'Tab2WS', 'Connecting to game server ', 'Connecting to: ', 'connectedTab3', 'not connected', 'Tab1Connected', 'Tab2Connected', 'Tab3Connected', ' connected', 'getBuffer', 'clearCells', ' disconnected', 'Websocket Closed', 'Websocket errored out!', 'IP: [', 'serverToken', 'region', 'readyState', 'OPEN', 'protocolKey', 'protocolKey3', 'clientKey', 'generateClientKey', 'imul', 'shiftKey', 'setUint8', 'shiftMessage', 'readUInt8', 'getMyCellId', 'getLeaderboardTeam', 'getLeaderboardFFA', 'getGhost', 'mobileData', 'ping', 'compressedPacket', 'ghostCells', 'ghostData', 'getSpectateData', 'Tab3SpectatePoints', 'Reseting World...', 'Reset Protocol Key 1: ', 'Reset Protocol Key 2: ', 'Reset Protocol Key 3: ', 'Clearing tab 1 world', 'Clearing tab 3 world', 'getLeaderboard', 'unnamed cell', 'getReceiveKey', 'Protocol Key 1: ', ' | Client Key 1: ', 'Protocol Key 2: ', ' | Client Key 2: ', 'clientKey3', 'Protocol Key 3: ', ' | Client Key 3: ', 'worldUpdate', 'borderUpdate', 'refreshTime', 'removeCell', 'pong', 'triedCoins2', 'handshake2', 'Connected to: ', 'createView', 'connected', 'sendPacket', 'handshake1', 'setUint32', 'setInt32', 'Captcha Token Sent: ', 'ready', 'execute', 'sendToken', 'versionString', 'writeUint32', ' trying to get free coins. Retry after 1 hour.', 'proxyMobileData', '[Miniclip] Tab ', ' trying to open potion ', 'unshift', 'setUint16', '<div class=\"info\"><i class=\"fas fa-copyright\"></i> 2019 HSLO.</div>', 'finishUp', 'wss.ogario.eu:3443', 'ogarWS1', 'Connecting to Ogario Networks.', 'Disconnected from Ogario server. (', 'OGARio', ' disconnected from szymy\'s server.', 'Connection to Ogario server errored out! (', 'handshake', 'partyToken', 'sendString', 'sendInteger', 'PTY', 'positionMass', 'playerID2', 'playerID', 'Sending OGARio Buffer ', 'unnamed', 'class_e', 'data', 'selfID', '_000054', 'prePlayersData', 'prePlayersAlive', 'getPlayer', 'cmder', 'date', '[SERVER]', ' connected to szymy\'s server.', 'newPlayer', 'cache', 'save', '#09f', '192px Verdana', 'strokeRect', 'Tab 1 viewport', '#0d00ff', 'Tab 2 viewport', 'Tab 3 viewport', 'shadowColor', 'maouImg', 'fantasyImg', 'resizeCanvas', 'getMaouImg', 'getEveryoneSkin', 'getFantasyImg', 'onresize', 'clearRect', 'scale', 'translate', 'drawFantasyImg', 'mouseTracker', 'SplitRings', 'cells', 'hideOwnNick', 'indicator', 'getColor', 'https://i.imgur.com/UHnXvDk.png', 'https://i.imgur.com/dne3Rtn.png', 'cacheFantasy', 'cacheFantasyCanvas', 'cacheFantasyCtx', 'changeBGImage', 'bgURL', 'customBG', 'changeLB', 'LBHead', 'customLB', 'MBURL', 'customMB', 'musicPlayer', 'specTop', 'Reconnecting Tab One', 'You\'ve to turn on multibox mode first!', 'Reconnecting Tab Two', 'reconnectTabThree', 'Reconnecting Tab Three', 'editEmojiLink', 'https://hslo.yueagar.ml/emojis/', 'renderCanvas', 'CanvasRenderer', 'PIXI.js loaded!', 'https://i.imgur.com/H7oaPKw.png', '<iframe width=\"100%\" height=\"60\" src=\"https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2FJS_Nightcore%2Fnightcore-mix-2%2F\" frameborder=\"0\" ></iframe>', 'getSettings', 'checked', 'checkSettings', 'checkTheme', 'checkHotkeys', 'checkCommands', 'checkMouse', 'checkExtra', 'extra', 'loadSettings', 'object', 'Error! Not an object!', 'checkProfiles', 'botsName', 'F5 to see effects.', 'resetSettings', 'removeItem', 'XXXXXXX', 'getRainbowFlag', 'createRadialGradient', 'addColorStop', 'rgba(0,0,0,0)', 'lineCap', 'lineJoin', 'round', '#656565', 'parsedKey', '3.6.1', 'Current Client Version: ', 'ajax', '//agar.io/mc/agario.js', 'Failed to scan client version.', 'Updated Client Version: ', 'New client version found! Updating...', 'game', 'clientVersion', 'reconnectTabOne', 'reconnectTabTwo', 'loop', 'reload', 'platform', 'Mac', 'stopPropagation', 'checkConsole', '3pF4N(>c@,hqnNG<', 'U>P#&[N2_#q^_rmF', '5cB8p{S\"!D:Fhd7S', '$_R6)=@W>aHb3qh?', 'Ð“ÑžÐ²â€žÑžÐ’ÒHSLOV5-Friends-TokenÐ“ÑžÐ²â€žÑžÐ’Ò', ',L_X6?CgxGNx^<<(', 'pwd', 'pwdBox', 'Loading Extension Core...', 'PYmDUt', 'return (function() {}.constructor(\"return this\")( ));', 'atob', 'replace', 'charAt', 'fromCharCode', 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=', 'indexOf', 'psqXSL', 'length', 'toString', 'slice', 'charCodeAt', 'nQVQtX', 'prmOHq', 'isArray', 'iterator', 'next', 'done', 'value', 'return', 'Invalid attempt to destructure non-iterable instance', 'apply', 'return (function() ', '{}.constructor(\"return this\")( )', 'item', 'attribute', 'jWGyXuQeaZgarJ.ml;agaLMr.FIhio;yuQkjeaDpcgarh.gzaTfPckKkAvAtWXMcYIpQtBzELSOztRPMBXhDRTPbfMRvznMXHFMqEPSX', 'console', 'log', 'warn', 'debug', 'info', 'error', 'exception', 'trace', 'enumerable', 'writable', 'defineProperty', 'key', 'dev', 'test', 'prototype', 'getItem', 'version', '5.3.2', 'old', 'HSLO530-', 'latest', 'HSLO532-', 'prefix', 'includes', 'get', 'parse', 'stringify', '#000000', 'set', 'hex', '_000482', '_000481', 'getColorObject', 'event', 'run', 'requestAnimationFrame', 'containerNode', '#loading-screen', '#loading-screen .status .icon', 'statusMessageNode', '#loading-screen .status .message', 'fadeOutTime', 'iconList', '<i class=\"fas fa-circle-notch fa-spin\"></i>', '<i class=\"fas fa-exclamation-circle\"></i>', 'statusIcon', 'success', 'statusMessage', 'fadeOut', 'text', 'statusIconNode', 'html', 'Please wait, loading...', 'init', 'default', 'change', '[Hstr]', 'update', 'attr', 'Hstr', 'split', 'lang_', 'selected', 'lang_EN', 'language', 'current', 'browser', 'toUpperCase', 'supported', 'Settings', 'Play', 'Theme', 'Tag 2', 'Nick', 'Teams', 'Experimental', 'Party token', 'Join', 'Get', 'Load', 'Reset', 'You can\'t play in double tag mode.', 'Connected to HSLO Networks.', 'Invalid skin URL', 'Logged in from last session data.', 'SDK not loaded', 'Already logged in.', 'Logged in', 'Logged out', 'You can\'t change nick while in game.', 'Click a cell to begin targeting it. See instructions in mouse settings menu.', 'Targeting is turned off. Turn it on in settings menu in order to use it.', 'Account does not exist.', 'LEADERBOARD', 'Enter chat message...', 'Team Players', 'Score', '#1 position', 'Paused', 'BIGGEST CELL VIEWPORT', 'VIEWPORT FOLLOWING MOUSE', 'TARGETING PLAYERS', 'Language', 'Mass Update Interval [ms]', 'Cell eat [sucking] animation', 'Auto zoom', 'Cell text animation', 'Auto hide text', 'Hide own nick', 'Hide own mass', 'Hide own skin', 'Cell nick', 'Cell mass', 'Nick shadow', 'Mass shadow', 'URL skins', 'HSLO skins', 'Food', 'Vanilla grid', 'Background sectors', 'Cursor lines', 'Opponent rings', 'Split rings', 'Viruses range', 'Teammate indicator', 'Border Glow', 'Virus Glow', 'Chat type', 'Multibox Mode', 'Sounds', 'Show Bot Notification and Count', 'Off', 'Stepped', 'Linear', 'Mass', 'Performance', 'Normal', 'Fantasy', 'Url skins', 'Hslo skins', 'All skins', 'Mono colored', 'Rainbow', 'Only lines', 'Snowflakes', 'Chatroom', 'Toggle main menu', 'Feed', 'Macro feed', 'Split', 'Double split', 'Split 16', 'Stop cell movement', 'Toggle chat', 'Toggle spectate mode', 'Toggle split rings', 'Toggle opponent rings', 'Toggle cell nick', 'Toggle skin', 'Quick respawn', 'Command 0', 'Command 1', 'Command 2', 'Command 3', 'Command 5', 'Command 6', 'Command 7', 'Command 8', 'Command 9', 'Command Up', 'Command Down', 'Command Left', 'Command Right', 'Zoom level 1', 'Zoom level 4', 'Zoom level 5', 'Commander', 'Left click', 'Right click', 'Targeting', 'Lock target 1', 'Lock target 2', 'Middle click or Toggle spectate key', 'Toggle top cell mode to follow mouse mode', 'Toggle targeting mode to follow mouse mode', 'Toggle follow mouse mode to top cell mode', 'Commands', 'Fuck!', 'Feed Me!', 'Split into me!', 'Need backup at %sector%!', 'Enemy spotted at %sector%!', 'Need a teammate!', 'Tank the virus!', 'Eat the virus!', 'Let\'s bait!', 'Fake tricksplit!', 'Up!', 'Bottom!', 'Left!', 'Right!', 'Theme preset', 'Leaderboard size', 'Chatroom size', 'Minimap size', 'Skin border', 'Cell transparency', 'Lighten cell color', 'Border color', 'Border width', 'Grid color', 'Grid text color', 'Grid text font', 'Grid width', 'Border Glow Size', 'Virus Glow Size', 'Nick stroke color', 'Nick size', 'Nick font', 'Mass color', 'Mass size', 'Mass font', 'Food color', 'Food size', 'Food Glow Size', 'Food Glow Strength', 'Virus border color', 'vir
›Ð“Â¬Ð’ÑœÐ’Ò‘Ð“Â¬Ð’Ð…Ð›Ñš Ð“Â­Ð’ÐƒÐ’Â¬Ð“Ð„Ð’Ñ‘Ð’Â°', 'Ð“Â­Ð•â€™Ð²â€šÂ¬ 1 Ð“Â¬Ð–â€™Ð²Ð‚Â°[Ð“Â«Ð’ÐŒÐ²Ð‚ÑœÐ“Â«Ð’Ñ‘Ð²Ð‚Ñœ Ð“Â­Ð–â€™Ð•â€œÐ“Ð„Ð’Â·Ð’Ñ‘ Ð“Â«Ð’Ð„Ð’ÐÐ“Â«Ð²Ð‚ÑšÐ•â€œ]', 'Ð“Â­Ð•â€™Ð²â€šÂ¬ 2 Ð“Â¬Ð–â€™Ð²Ð‚Â°[Ð“Â«Ð’ÐŒÐ²Ð‚ÑœÐ“Â«Ð’Ñ‘Ð²Ð‚Ñœ Ð“Â­Ð–â€™Ð•â€œÐ“Ð„Ð’Â·Ð’Ñ‘ Ð“Â«Ð’Ð„Ð’ÐÐ“Â«Ð²Ð‚ÑšÐ•â€œ]', 'lang_ES', 'Jugar', 'Espectear', 'Tema/DiseÐ“Ñ“Ð’Â±o', 'Tag', 'Skin URL (imgur)', 'Codigo Party', 'Entrar', 'Crear', 'Conectado a HSLO Networks.', 'Ya te encuentras conectado.', 'Conectado', 'Error al conectar!', 'Desconectar', 'No puedes cambiar tu nickname cuando te encuentras jugando.', 'Haga clic en una celula para comenzar a seguirla. Vea las instrucciones en el menÐ“Ñ“Ð’Ñ” de configuraciÐ“Ñ“Ð’Ñ–n del mouse.', 'El seguimiento estÐ“Ñ“Ð’ÐŽ desactivada. EnciÐ“Ñ“Ð’Â©ndalo en el menÐ“Ñ“Ð’Ñ” de configuraciÐ“Ñ“Ð’Ñ–n para usarlo.', 'Ingresa el mensaje...', 'PuntuaciÐ“Ñ“Ð’Ñ–n', '#1 PosiciÐ“Ñ“Ð’Ñ–n', 'Pausado', 'MASA TOTAL', 'Lenguaje', 'Retraso de animaciÐ“Ñ“Ð’Ñ–n', 'Velocidad del Zoom', 'Celula comiendo animacion', 'Auto Ocultar texto', 'Nick de la celula', 'Trazo del nick', 'Trazo del masa', 'Comida/Pellets', 'Cuadricula Vanilla', 'Linea del cursor', 'Rango del oponente', 'Rango del virus', 'Indicador de compaÐ“Ñ“Ð’Â±ero', 'SeÐ“Ñ“Ð’Â±al/Comandante', 'Tipo de Chat', 'Sonidos', 'Desactivado', 'Lineal', 'Completo', 'Nick + Masa', 'Todas las skins', 'Arcoiris', 'Solo lineas', 'Copos de nieve', 'Hotkeys', 'Ocultar menu principal', 'Cebar', 'Cebar rapido [Macro]', 'Dividirse', 'DivisiÐ“Ñ“Ð’Ñ–n doble', 'Detener el movimiento de la celula', 'Ocultar Chat', 'Ocultar nick de la celula', 'Ocultar masa de la celula', 'Ocultar skin', 'Ocultar comida/pellets', 'Reaparicion rapida', 'Comando 0', 'Comando 1', 'Comando 2', 'Comando 3', 'Comando 4', 'Comando 5', 'Comando 6', 'Comando  7', 'Comando 8', 'Zoom nivel 2', 'Zoom nivel 3', 'Zoom nivel 5', 'Cebar rapido[Macro]', 'Division', 'Comandante', 'Clic izquierdo', 'Clic central(Rueda)', 'Comandos', 'Mierda!', 'Alimentame!', 'Dividete en mi!', 'Necesito ayuda en %sector%!', 'Necesito compaÐ“Ñ“Ð’Â±ero!', 'Lanza el virus!', 'Come el virus!', 'Haz baiteo!', 'Puntero', 'TamaÐ“Ñ“Ð’Â±o del leaderboard', 'TamaÐ“Ñ“Ð’Â±o del minimapa', 'Transparencia de la celula', 'Claridad del color de la celula', 'Color del borde', 'Ancho del borde', 'Color del grid', 'Color del texto del grid', 'TamaÐ“Ñ“Ð’Â±o de texto del grid', 'Fuente de texto del grid', 'Ancho del grid', 'Color del nick', 'Color del borde del nick', 'Fuente del nick', 'Color de la masa', 'Color del borde de la masa', 'TamaÐ“Ñ“Ð’Â±o de la masa', 'Fuente de la masa', 'TamaÐ“Ñ“Ð’Â±o de la comida', 'Color del virus', 'Color del borde del virus', 'Ancho del borde del virus', 'Decoracion del virus', 'Color del fondo', 'Color del comandante', 'TamaÐ“Ñ“Ð’Â±o del indicador de compaÐ“Ñ“Ð’Â±ero', 'Color Equipo 2 [Modo doble TAG]', 'Activado', 'HSLO V5 Special Edition - 5.3.2 (17)', 'isOpened', 'div', '#settings', 'settings', 'CellAnimation', 'eatAnimation', 'massUpdateInterval', 'zoomSpeed', 'cameraSpeed', 'off', 'cellTextAnimation', 'autoHideText', 'cellNick', 'nickShadow', 'cellMass', 'massShadow', 'virusMass', 'hideOwnMass', 'hideOwnSkin', 'urlSkins', 'hsloSkins', 'food', 'bgSectors', 'normal', 'vanillaGrid', 'cursorLine', 'teamIndicator', 'opponentRings', 'splitRings', 'virusRange', 'borderGlow', 'virusGlow', 'foodGlow', 'multiboxRing', 'maouCircleSkin', 'commander', 'sounds', 'topZoom', 'showViewportBoxes', 'showBotNotifNCount', 'targeting', 'chatType', 'popup', 'multiboxMode', 'alert', 'HSLO', 'Multibox mode [', 'setDomValues', 'each', 'type', 'range', 'handleRange', 'options', 'toggleChatroom', 'addEvents', '.settings-container', 'perfectScrollbar', '.settings-container .fa-chevron-left', 'parent', '.settings-container span.outer', 'click', 'offsetX', '.settings-container .fa-chevron-right', 'handleOptions', '.settings-close', 'toggle', 'close', 'open', 'fadeIn', 'name', 'find', 'active', 'class', 'removeAttr', 'saveSettings', 'span', 'min', 'max', 'step', 'css', 'width', 'isAliveTab2', 'Tab 2 must not be alive', 'Tab2', 'protocolKey2', 'clientKey2', 'loggedIn2', 'wss://', 'address', 'binaryType', 'arraybuffer', 'onmessage', 'onMessage', 'onClose', 'onerror', 'onError', 'ogarWS2', 'connectedIndex', 'onOpen', 'onclose', 'changeLanguage', 'nickCaches', 'clear', 'massCaches', 'selectedPreset', 'custom', 'theme', 'refresh', '#chatroom', 'show', 'hide', 'hotkeys', '#inputs', 'target', '#hotkeys', 'removeClass', '#mouse', '.inputs-tab[target=\"#hotkeys\"]', 'addClass', '.inputs-tab[target=\"#mouse\"]', '.inputs-tab[target=\"#commands\"]', '#commands', 'mouse', 'commands', '.inputs-tab.close', 'profiles', 'tag', 'profile ', 'https://i.imgur.com/mSs3u6X.png', 'profile', '#nick', 'val', 'nick', '#nick2', 'nick2', '#skin', '#skin2', 'skin2', '#tag', 'updateMainSkin', 'updatePreviewSkin', '.skin-wheel', '.menu-blur', 'wheelIsOpened', 'blur', 'spectator', 'setNick2', 'setSkin', 'setSkin2', 'switch', 'skin', 'setNick', 'getImgurCode', 'code2Url', '.skin-preview', 'background', 'url(', '.skin-selector[value=', 'classb', 'toggleMenuKey', 'ESC', 'feedKey', 'macroFeedKey', 'splitKey', 'doubleSplitKey', 'split16Key', 'stopKey', 'chatKey', 'ENTER', 'multiboxTab', 'togglemultiboxRing', 'freeSpectateKey', 'toggleSplitRings', 'toggleOpponentRings', 'toggleNick', 'toggleMass', 'toggleBGsectors', 'toggleFood', 'toggleSkin', 'respawnKey', 'command0Key', 'command1Key', 'command3Key', 'command4Key', 'command5Key', 'command6Key', 'command7Key', 'command8Key', 'command9Key', 'command11Key', 'command12Key', 'DOWN', 'command13Key', 'command14Key', 'RIGHT', 'zoom1key', 'ALT+1', 'zoom2key', 'ALT+2', 'zoom3key', 'zoom4key', 'ALT+4', 'zoom5key', 'ALT+5', 'pressedKeys', 'setDomKeys', '#hotkeys .row', '.key', '#hotkeys .row .key', 'keydown', 'preventDefault', 'setKey', 'addEventListener', 'onKeyDown', 'keyup', 'onKeyUp', 'keyCode', 'getKey', 'has', 'chat', 'isFocused', 'isAlive', 'toggleSpectate', 'respawn', 'doubleSplit', 'stopMovementToggle', 'toggleCellNick', 'toggleCellMass', 'toggleGameFood', 'togglemaouCircleSkin', 'command', 'command2Key', 'setZoom', 'delete', 'macroFeed', 'alreadyBinded', 'DEL', '] input', 'isValidKey', 'which', 'ctrlKey', 'CTRL+', 'ALT+', 'SPACE', 'SHIFT', 'TAB', 'LEFT', 'TILDE', 'leftClick', 'middleClick', 'rightClick', 'canvas', 'getElementById', 'canvasX', 'canvasY', 'send', 'getOffset2', 'controllingTab', 'getOffset3', 'viewport', 'height', 'isSpectating', 'isTurnedOn', 'center', 'movementPaused', '.mouse-options', '#mouse .fa-chevron-left', '#mouse .fa-chevron-right', 'mousemove', 'clientX', 'clientY', 'mousedown', 'onMouseClick', 'mouseup', 'onMouseRelease', 'wheel', 'contextmenu', 'targetViewport', 'wheelDelta', 'innerWidth', 'innerHeight', 'lockTarget', 'feed', 'split16', 'saveMouseOptions', 'bmk=', 'load', 'command1', 'commandsMenu', 'command2', 'command3', 'command4', 'command5', 'command6', 'command7', 'command8', 'command9', 'command0', 'command11', 'command12', 'command13', 'command14', 'setCommand', 'eject', 'ejectInterval', 'offset', '{\"type\":\"cmder\",\"x\":', ',\"y\":', ',\"date\":', 'now', 'freeSpec', 'reset', 'target1', 'turnedOn', 'target2', 'mouseViewport', 'freeSpectate', 'topViewport', 'enter', 'getLocation', 'message', 'shortened', 'monoColored', 'isConnected', 'spawn', 'isAliveTab1', 'masterUrl', 'https://webbouncer-live-v8-0.agario.miniclippt.com/v4', 'contentType', 'application/octet-stream', 'xSupportProtoVersion', '15.0.3', 'getRegionsInfo', 'POST', 'https://webbouncer-live-v8-0.agario.miniclippt.com/info', 'responseText', 'getServer', ':party', 'setHeaders', 'Searching for a party server', 'getToken', 'setRequestHeader', 'Accept', 'text/plain', '*/*', 'q=0.01', 'x-support-proto-version', 'x-client-version', 'versionInt', 'getTokenIP', 'https://webbouncer-live-v8-0.agario.miniclippt.com/v4/getToken', 'Joining game server ', '#party-token', 'endpoints', 'https', 'createToken', '/createToken', 'HSLO: Creating game server token.', 'token', '/getToken', 'HSLO: Can not get game server token.', 'Getting game server token.', 'HSLO: Getting gamem server token.', 'Can not get game server token.', '#join-party', '#create-party', 'createParty', 'setRegions', 'North America', 'South America', 'Europe', 'Russia', 'East Asia', 'China', 'Oceania', ')</option>', '#regions', 'joinParty', 'connectWithIp', '#gamemode', 'match', ':teams', ':experimental', 'EXP', '?party_id=', '.agar.io:80', 'siteKey', '6LfjUBcUAAAAAF6y2yIZHgHIOO5Y3cU5osS2gbMl', 'container', '#captchaWindow', 'asyncInit', 'onloadCallback', 'requestV3', 'onceLoad', 'render', 'captchaWindowV3', 'inline', 'invisible', 'display', 'Agario', ' Captcha Callback', 'afterCheck', 'verifyUser', 'inited', 'Tab ', ' Captcha Aftercheck', 'captcha', '#theme', 'skinBorder', 'lbSize', 'minimapSize', 'chatFontSize', 'chatroomSize', 'cellTransparency', 'lightenCellColor', 'borderWidth', 'borderColor', '#ffffff', 'team1color', 'team2color', '#ff171f', 'multiboxActive', 'multiboxInactive', '#fff', '#ff0066', 'multiboxRingWidth', 'nickColor', 'nickStrokeColor', '#000', 'cellNickSize', 'nickFont', 'ubuntu', 'massColor', 'massStrokeColor', 'cellMassSize', 'massFont', 'gridWidth', 'borderGlowSize', 'borderGlowStrength', 'virusGlowSize', 'virusGlowStrength', 'foodGlowSize', 'foodGlowStrength', 'gridColor', '#111', 'gridTextColor', 'gridTextSize', 'gridTextFont', 'foodSize', 'foodColor', 'virusColor', '#8f8f8f', 'virusBorderColor', '#c2c2c2', 'virusBorderWidth', 'commanderColor', '#f5e35d', 'backgroundColor', 'indicatorSize', 'cursor', 'cursorLineColor', 'ghostColor', '#ffae00', 'selfColor', 'selfViewportColor', 'selfViewportAlpha', 'topViewportColor', '#ff0000', 'topViewportAlpha', 'teammateColor', '#555', 'teammateNameColor', 'fantasyColor', 'fantasyAlpha', 'addPresets', '.theme-options', 'colorpicker', 'initColorpicker', 'setChatFontSize', 'setChatroomSize', 'setBackground', 'setMinimap', 'setCursor', '.theme-container', '.theme-container .fa-chevron-left', '.theme-close', 'saveTheme', 'input', 'opacity', 'minicolors', 'bottom right', 'selectPreset', 'setLeaderboard', 'setNickCtxFont', 'body', '#notifications', 'span.chattime', 'font-size', 'span.message', 'scrollTop', 'chatroomdiv', 'scrollHeight', '#leaderboard-head', '#leaderboard-positions', '#minimap-hud, .minimap-grid', '.minimap-sector', '.minimap-head', '#time-hud', 'url(),auto', '#cursorOff', '#cursorDisplay', 'url(https://jimboy3100.github.io/cursors/cursor_', '.cur),auto', 'src', 'https://jimboy3100.github.io/cursors/cursor_', '.cur', 'presets', 'hasOwnProperty', 'Acydwarp', '#aeaeae', '#fff700', '#1a1a1a', '#0849d4', '#808080', '#9e9e9e', 'full', 'sans-serif', '#6111ff', 'Szymy', '#01d9cc', '#00243e', '#5000ff', '#002f52', '#000a11', '#116111', '#333333', '#6fff00', '#55b304', '#00fff7', 'KSCC', '#444444', '#4b6efa', 'stepped', 'Eric', '#666666', '#444', '#222222', '2coolife', '#007777', '#ff006f', '#121212', 'oswald', '#555555', 'snowflakes', '#ff9900', '#f5d25f', '#fa676c', '#7a4ba3', '#ead2fa', 'classoe', 'animDuration', 'iconChat', 'iconAlert', 'iconBell', '<i class=\"fa fa-bell\"></i>', 'emojiPath', 'emojis', 'angry.png', 'angry-1.png', 'crying-1.png', 'embarrassed.png', 'happy.png', 'happy-1.png', 'happy-2.png', 'kiss.png', 'laughing.png', 'laughing-1.png', 'poo.png', 'sad.png', 'sad-1.png', 'shocked.png', 'shocked-1.png', 'sick.png', 'sleeping.png', 'tongue.png', 'tongue-1.png', 'vomit.png', 'wink.png', 'thinking-distort.png', 'pepe-tears2much.png', 'pepe-heart.png', 'parrot-thuglife.gif', 'blob-happy.png', 'leny.png', 'displayEmojis', '#emojiContainer', '<img src=\"https://hslo.yueagar.ml/emojis/', '\" class=\"emojiPreview\">', '#message', 'focus', 'append', 'playChat', 'chatroom', '<div><div class=\"normal\">', '<span class=\"nick\">', '</span><span class=\"message\">', 'putEmojis', 'cleanMessages', '</span></div></div>', '<div><div class=\"command\">', 'playAlert', '<div><div class=\"alert\">', 'slideUp', 'appendTo', 'slideDown', 'remove', 'duration', '<img src=\"', 'getHours', 'getMinutes', '<div class=\"chatroom-row\"><span class=\"chattime\">', '</span> ', ' <span class=\"nick\">', 'toaster', 'https://jimboy3100.github.io/sounds/notification_01.mp3', 'cmdSound', 'https://cdn.ogario.ovh/static/sounds/notification_02.mp3', 'alertSound', 'https://jimboy3100.github.io/sounds/chat-message.mp3', 'chatSound', 'catch', 'playCmd', 'play', 'then', 'loggedIn', 'button', '#login-facebook', 'v2.8', 'setDomElements', 'login', '#logout', 'logout', 'notif', 'sdk_error', 'extras', 'expiry', 'fbToken', 'Facebook', 'login_lastSession', 'freeCoins', 'logged', 'afterLogin', 'public_profile, email', 'accessToken', 'authResponse', 'expiresIn', 'login_success', 'login_error', 'triedCoins', 'googleToken', 'Google+', 'gapi', 'auth2', '686981379285-oroivr8u2ag1dtm3ntcs6vi05i3cpv0j.apps.googleusercontent.com', 'single_host_origin', 'login-google', 'attachClickHandler', 'getAuthResponse', 'id_token', 'expires_at', '#login-google', 'getAuthInstance', 'signOut', 'getHTML', 'dataHTML', 'playersAmount', 'list', 'teamLB', '#leaderboard-chart', 'barsCss', 'createElement', 'style', 'head', 'add', 'team', 'teamLBvisible', 'innerText', 'px } .chart-bar.green { width: ', 'px } .chart-bar.blue { width: ', 'px }', 'innerHTML', 'cleanNick', 'mass', 'mass1', '] [', 'position', 'hidden', 'block', 'dataAmount', 'element', 'none', '.lb-position', '.lb-data', 'children', 'push', 'ctx', 'getContext', 'size', 'pi2', 'ratio', 'textAlign', 'textBaseline', 'bottom', 'lineWidth', 'renderViewport', 'renderDeathLocation', 'renderGhost', 'renderSelf', 'viewBounds', 'left', 'top', 'right', 'globalAlpha', 'fillStyle', 'fillRect', 'renderTopViewport', 'bound3', 'deathLocation', 'strokeStyle', '#666', 'beginPath', 'moveTo', 'lineTo', 'stroke', 'arc', 'closePath', 'rgba(0, 0, 0, 0.5)', 'offset3', 'fill', 'renderTeammates', 'font', '700 12px ubuntu', 'values', 'time', 'lastUpdateAt', 'worldID', 'worldID2', 'animate', 'mapX', 'mapY', 'lastUpdateTime', 'totalmass', 'alive', 'spectate', 'temporayArray', '#teamlist-positions', '#teamlist-spectate span', '#teamlist-alive span', '#teamlist-totalmass span', 'generateList', 'positions', 'teammates', 'sort', 'addPlayer', '<div class=\"tl-player\"><div class=\"tl-player-image\" style=\"background-image: url(', 'code2url', 'O5k0G4p', '); background-color: ', 'colorHex', ';\"></div><div class=\"tl-player-info\"><div class=\"tl-player-nick\">', ' <i class=\"fas fa-volleyball-ball\"></i> ', '</div><div class=\"tl-player-massbar\"><div class=\"tl-player-massbar-fill\" style=\"width: ', '%;\"></div></div></div></div>', '#message-hud', 'substring', 'fpsCount', 'icon', '<i class=\"fa fa-lock\"></i>', '<i class=\"fa fa-tachometer-alt\"></i>', '<i class=\"fa fa-pause-circle\"></i>', 'fps', 'score', 'paused', 'zoomLock', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Saturday', 'getDay', 'getFullYear', 'getMonth', 'getDate', 'getSeconds', 'timeHud', 'autoZoom', 'lockClosed', '   Mass: ', '   ', 'n16', 'STE', 'biggestPieceMass', 'STE: ', 'speed', 'animSpeed', 'speedometer', 'px/s   ', 'PIO', 'packetCount', 'out', 'PIO: ', 'iconPause', ' <strong>Paused</strong>]   ', 'FPS: ', 'stack', 'lastIndexOf', '#targeting-hud', 'DIVno1viewport', '#targeting-no-1', '#targeting-mouse', 'DIVplayers', '#targeting-players', 'DIVtotalmass', '#targeting-playersMass span.mass', 'DIVplayer1', '#targeting-player1 span.nick', '#targeting-player1 span.mass', '#targeting-player2 span.nick', '#targeting-player2 span.mass', 'lastTime', 'outOfView', 'OUT OF VIEW', 'Target 1', 'DIVplayer2', 'Target 2', 'NOT SELECTED', 'DIVmouse', '#spectate-mode-top', '#spectate-mode-mouse', '#spectate-mode-target', 'targetMode', 'setMassUpdateInterval', '#menu-overlay', 'streammode', 'toggleStreammode', 'buttons', 'versionCheck', 'closeSubMenus', '#button-play', '#button-spectate', 'death', '#button-inputs', 'JP-Tokyo', 'gameMode', 'gMode', '#minimap-show-1', '#minimap-show-', 'selector', '#minimap-show-2', '#minimap-show-0', '#streamMode', 'spectateModeTop', 'spectateModeMouse', 'spectateModeTarget', '#anouncement', 'openedChangelog', '#changelog', '#leaderboard-hud', '-2px', '#teamlist-hud', '10px', '0px', '30px', '45px', '.menu-bar', '35px', '#nick, #nick2, #tag, #skin, #skin2, #party-token', 'input-hidden', '<i class=\"fas fa-eye\"></i>', '<i class=\"fas fa-eye-slash\"></i>', 'targeting_on', '5.3.2 (17)', 'showChangelog', 'setItem', 'Great! Your extension is updated!.', 'updateHud', 'title', '<br>', 'versionChange', '<hr>', '<br><hr><div align=\"right\">2019-11-26</div>', 'cellsTab1'];
...
((window, $, document) => {
    ...
    o = (() => {
		function _3501913(_1249416) {
			const _3936561 = this;
			plzsuckmydick(this, _3501913), this.event = _1249416, window.requestAnimationFrame(() => {
				_3936561.run();
			});
		}
    ...
    window.t = new((() => {
		function _4980734() {
			plzsuckmydick(this, _4980734), this.containerNode = $('#loading-screen'), this.statusIconNode = $('#loading-screen .status .icon'), this.statusMessageNode = $('#loading-screen .status .message'), this.fadeOutTime = 500, this.iconList = {
		...
		/*window.t = new (class{
			constructor(){
			  ...
			  finishUp() {
				...
				set statusMessage(_4980734) {
					this.statusMessageNode.text(_4980734);
				}
				set statusIcon(_4980734) {
					this.statusIconNode.html(this.iconList[_4980734]);
				}
		})
		*/
		...
		return plzdsmd(_3015850, [{
			...
			'value'() {
				...
				$('.settings-container').perfectScrollbar(), $('.settings-container .fa-chevron-left').each(function () {
					const _3015850 = this;
					$(this).click(() => {
						const _1196931 = $(_3015850).parent(),
							_7359342 = $(_1196931).attr('type');
						'options' === _7359342 ? settings.handleOptions(_1196931, 0) : 'range' === _7359342 && settings.handleRange(_1196931, 0);
					});
				}), $('.settings-container span.outer').each(function () {
					const _3015850 = this;
					$(this).click(_1685639 => {
						const _5318914 = $(_3015850).parent();
						settings.handleRange(_5318914, 3, _1685639.offsetX);
					});
				}), $('.settings-container .fa-chevron-right').each(function () {
					const _3015850 = this;
					$(this).click(() => {
						const _5410500 = $(_3015850).parent(),
							_2646041 = $(_5410500).attr('type');
						'options' === _2646041 ? settings.handleOptions(_5410500, 1) : 'range' === _2646041 && settings.handleRange(_5410500, 1);
					});
				}), $('.settings-close').click(() => _3015850.close());
			}
		}, {
			'key': 'toggle',
			'value'() {
			...
			'value'(_3015850, _3899211) {
				for (var _2392579, _5930881 = $(_3015850).attr('name'), _16350690 = $(_3015850).find('b'), _5596694 = _16350690.length, _5596078 = _5596694, _13696003 = 0; _5596078--;) _2392579 = _16350690[_5596078], 'active' === $(_2392579).attr('class') && (_13696003 = _5596078);
				if (1 === _3899211) {
					const _3015850 = _13696003 + 1 < _5596694 ? _13696003 + 1 : 0;
					$(_16350690[_13696003]).removeAttr('class'), $(_16350690[_3015850]).attr('class', 'active');
					const _3899211 = $(_16350690[_3015850]).attr('value');
					...
					$(_16350690[_13696003]).removeAttr('class');
					for (let _3015850, _3899211 = _5596694; _3899211--;)
						if (_3015850 = _16350690[_3899211], $(_3015850).attr('value') === this[_5930881]) {
							$(_3015850).attr('class', 'active');
							break;
						}
				}
			}
			...
			'value'(_3015850, _5767755) {
				const _16544537 = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
					_3541509 = $(_3015850).attr('name'),
					_16350690 = $(_3015850).find('span'),
					_13547690 = _16350690[0],
					_1819679 = _16350690[1],
					_1057660 = $(_16350690[2]),
					_5821427 = ~~$(_13547690).attr('min'),
					_1772312 = ~~$(_13547690).attr('max'),
					_4075378 = ~~$(_13547690).attr('step'),
					_98185 = ~~$(_13547690).attr('value');
				if (1 === _5767755 && _98185 + _4075378 <= _1772312) {
					const _3015850 = _4075378 + _98185;
					$(_13547690).attr('value', _3015850), $(_1819679).css('width', ~~(100 * (_3015850 - _5821427) / (_1772312 - _5821427)) + 'px'), _1057660.text(_3015850), this.saveSettings(_3541509, ~~_3015850);
				} else if (0 === _5767755 && _98185 - _4075378 >= _5821427) {
					const _3015850 = _98185 - _4075378;
					$(_13547690).attr('value', _3015850), $(_1819679).css('width', ~~(100 * (_3015850 - _5821427) / (_1772312 - _5821427)) + 'px'), _1057660.text(_3015850), this.saveSettings(_3541509, ~~_3015850);
				} else if (2 === _5767755) {
					const _3015850 = this[_3541509];
					$(_13547690).attr('value', _3015850), $(_1819679).css('width', ~~(100 * (_3015850 - _5821427) / (_1772312 - _5821427)) + 'px'), _1057660.text(_3015850);
				} else if (3 === _5767755) {
					...
					$(_13547690).attr('value', _3015850), $(_1819679).css('width', ~~_5767755 + 'px'), _1057660.text(_3015850), this.saveSettings(_3541509, ~~_3015850);
				}
			}
		}, {
			'key': 'saveSettings',
		...
		_5736151 = new((() => {
			...
			return plzdsmd(_1503136, [{
				...
				'value'() {
					...
					}), _1772312.set('profiles', 'profile' + this.selected, _1503136), $('#nick').val(_1503136.nick), $('#nick2').val(_1503136.nick2), $('#skin').val(_1503136.skin), $('#skin2').val(_1503136.skin2), $('#tag').val(this.tag), this.updateMainSkin();
				...
				'value'(_1503136) {
					...
					_6021625 || (_6021625 = {
						...
						'skin': 'https://i.imgur.com/mSs3u6X.png',
						'skin2': 'https://i.imgur.com/mSs3u6X.png'
					}), $('#nick').val(_6021625.nick), $('#nick2').val(_6021625.nick2), $('#skin').val(_6021625.skin), $('#skin2').val(_6021625.skin2), A.nick = _6021625.nick, A.nick2 = _6021625.nick2, A.skin = _6021625.skin, A.skin2 = _6021625.skin2, _1772312.set('profiles', 'profile' + this.selected, _6021625), this.updateMainSkin();
				}
			}, {
				'key': 'setNick',
				'value'(_1503136) {
    ...
    _ = new((() => {
		function _4514183() {
			plzsuckmydick(this, _4514183), this.leftClick = _1772312.get('mouse', 'leftClick') || 'off', this.middleClick = _1772312.get('mouse', 'middleClick') || 'off', this.rightClick = _1772312.get('mouse', 'rightClick') || 'off', this.x = 0, this.y = 0, this.canvas = document.getElementById('canvas'), this.canvasX = 0, this.canvasY = 0;
		}
		return plzdsmd(_4514183, [{
			...
			'key': 'onMouseWheel',
			'value'(_4514183) {
				let targetVP = L.targetViewport;
				0 > _4514183.wheelDelta ?
				 targetVP *= settings.zoomSpeed / 100 
				 : 
				 targetVP /= settings.zoomSpeed / 100, targetVP = 2 < targetVP ? 2 : 0.02 > targetVP ? 0.02 : targetVP, L.targetViewport = targetVP;
			}
		}, {
			'key': 'onMouseClick',
			'value'(_4514183) {
			...
			'value'(_4514183, _3724175) {
				for (var _11512343, _2858313 = $(_4514183).attr('name'), _16350690 = $(_4514183).find('b'), _4265360 = _16350690.length, _4784167 = _4265360, _2425684 = 0; _4784167--;) _11512343 = _16350690[_4784167], 'active' === $(_11512343).attr('class') && (_2425684 = _4784167);
				if (1 === _3724175) {
					const _4514183 = _2425684 + 1 < _4265360 ? _2425684 + 1 : 0;
					$(_16350690[_2425684]).removeAttr('class'), $(_16350690[_4514183]).attr('class', 'active');
					const _3724175 = $(_16350690[_4514183]).attr('value');
					...
					$(_16350690[_2425684]).removeAttr('class');
					for (let _4514183, _3724175 = _4265360; _3724175--;)
						if (_4514183 = _16350690[_3724175], $(_4514183).attr('value') === this[_2858313]) {
			...
			'value'(_4514183, _4144055) {
				const _4205648 = $(_4514183).attr('name'),
					...
					_5508027 = _2540822[1],
					_4345995 = ~~$(_16350690).attr('min'),
					_5104860 = ~~$(_16350690).attr('max'),
					_5821427 = ~~$(_16350690).attr('step'),
					_1772312 = ~~$(_16350690).attr('value');
				if (1 === _4144055 && _1772312 + _5821427 <= _5104860) {
					const _4514183 = _5821427 + _1772312;
					$(_16350690).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px'), this.saveMouseOptions(_4205648, _4514183);
				} else if (0 === _4144055 && _1772312 - _5821427 >= _4345995) {
					const _4514183 = _1772312 - _5821427;
					$(_16350690).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px'), this.saveMouseOptions(_4205648, _4514183);
				} else if (2 === _4144055) {
					const _4514183 = this[_4205648];
					$(_16350690).attr('value', _4514183), $(_5508027).css('width', ~~(100 * (_4514183 - _4345995) / (_5104860 - _4345995)) + 'px');
				}
			}
		}, {
		...
		return plzdsmd(_3325808, [{
			...
			'value'() {
				for (var _3325808 = {			
						...
						'wss://delta-ffa.glitch.me': 'Delta FFA',
						'wss://imsolo.pro:2102': 'FeelForeverAlone',
						'wss://delta-server.fly.dev': 'Antarctic',
						'wss://delta-selffeed.glitch.me': 'Zimbabwe',
    ...
    y = new((() => {
		function _1686623() {
			plzsuckmydick(this, _1686623), this.siteKey = '6LfjUBcUAAAAAF6y2yIZHgHIOO5Y3cU5osS2gbMl', this.inited = false, this.container = $('#captchaWindow');
		}
    ...
    oe = (() => {
		...
		return plzdsmd(_4989757, null, [{
			...
			'value'() {
				this.isOpened = false
				this.div = $('#theme')
				this.selectedPreset = _1772312.get('theme', 'selectedPreset') || 'custom'
				this.skinBorder = ~~_1772312.get('theme', 'skinBorder') || 100
				this.lbSize = ~~_1772312.get('theme', 'lbSize') || 110
				this.minimapSize = ~~_1772312.get('theme', 'minimapSize') || 200
				this.chatFontSize = ~~_1772312.get('theme', 'chatFontSize') || 14
				this.chatroomSize = ~~_1772312.get('theme', 'chatroomSize') || 50
				this.cellTransparency = ~~_1772312.get('theme', 'cellTransparency') || 100
				this.lightenCellColor = ~~_1772312.get('theme', 'lightenCellColor') || 100
				this.borderWidth = ~~_1772312.get('theme', 'borderWidth') || 60
				this.borderColor = _1772312.get('theme', 'borderColor') || '#ffffff'
				this.team1color = _1772312.get('theme', 'team1color') || '#aeaeae'
				this.team2color = _1772312.get('theme', 'team2color') || '#ff171f'
				this.multiboxActive = _1772312.get('theme', 'multiboxActive') || '#ff61f8'
				this.multiboxInactive = _1772312.get('theme', 'multiboxInactive') || '#fff'
				this.borderGlow = _1772312.get('theme', 'borderGlow') || '#ff0066'
				this.virusGlow = _1772312.get('theme', 'virusGlow') || '#ff0066'
				this.foodGlow = _1772312.get('theme', 'foodGlow') || '#ff0066'
				this.multiboxRingWidth = ~~_1772312.get('theme', 'multiboxRingWidth') || 10
				this.nickColor = _1772312.get('theme', 'nickColor') || '#fff'
				this.nickStrokeColor = _1772312.get('theme', 'nickStrokeColor') || '#000'
				this.cellNickSize = ~~_1772312.get('theme', 'cellNickSize') || 120
				this.nickFont = _1772312.get('theme', 'nickFont') || 'ubuntu'
				this.massColor = _1772312.get('theme', 'massColor') || '#fff'
				this.massStrokeColor = _1772312.get('theme', 'massStrokeColor') || '#000'
				this.cellMassSize = ~~_1772312.get('theme', 'cellMassSize') || 150
				this.massFont = _1772312.get('theme', 'massFont') || 'ubuntu'
				this.gridWidth = ~~_1772312.get('theme', 'gridWidth') || 100
				this.borderGlowSize = ~~_1772312.get('theme', 'borderGlowSize') || 20
				this.borderGlowStrength = ~~_1772312.get('theme', 'borderGlowStrength') || 1
				this.virusGlowSize = ~~_1772312.get('theme', 'virusGlowSize') || 20
				this.virusGlowStrength = ~~_1772312.get('theme', 'virusGlowStrength') || 1
				this.foodGlowSize = ~~_1772312.get('theme', 'foodGlowSize') || 20
				this.foodGlowStrength = ~~_1772312.get('theme', 'foodGlowStrength') || 1
				this.gridColor = _1772312.get('theme', 'gridColor') || '#111'
				this.gridTextColor = _1772312.get('theme', 'gridTextColor') || '#111'
				this.gridTextSize = _1772312.get('theme', 'gridTextSize') || 1500
				this.gridTextFont = _1772312.get('theme', 'gridTextFont') || 'ubuntu'
				this.foodSize = ~~_1772312.get('theme', 'foodSize') || 1
				this.foodColor = _1772312.get('theme', 'foodColor') || '#6111ff'
				this.virusColor = _1772312.get('theme', 'virusColor') || '#8f8f8f'
				this.virusBorderColor = _1772312.get('theme', 'virusBorderColor') || '#c2c2c2'
				this.virusBorderWidth = ~~_1772312.get('theme', 'virusBorderWidth') || 10
				this.commanderColor = _1772312.get('theme', 'commanderColor') || '#f5e35d'
				this.backgroundColor = _1772312.get('theme', 'backgroundColor') || '#000000'
				this.indicatorSize = ~~_1772312.get('theme', 'indicatorSize') || 100
				this.cursor = _1772312.get('theme', 'cursor') || 13
				this.cursorLineColor = _1772312.get('theme', 'cursorLineColor') || '#ffffff'
				this.ghostColor = _1772312.get('theme', 'ghostColor') || '#ffae00'
				this.selfColor = _1772312.get('theme', 'selfColor') || '#fff'
				this.selfViewportColor = _1772312.get('theme', 'selfViewportColor') || '#ffffff'
				this.selfViewportAlpha = _1772312.get('theme', 'selfViewportAlpha') || 1
				this.topViewportColor = _1772312.get('theme', 'topViewportColor') || '#ff0000'
				this.topViewportAlpha = _1772312.get('theme', 'topViewportAlpha') || 3
				this.teammateColor = _1772312.get('theme', 'teammateColor') || '#555'
				this.teammateNameColor = _1772312.get('theme', 'teammateNameColor') || '#fff'
				this.fantasyColor = _1772312.get('theme', 'fantasyColor') || '#fff'
				this.fantasyAlpha = _1772312.get('theme', 'fantasyAlpha') || 0
				this.addPresets()
				this.setDomValues()
				this.addEvents();
			}
			...
			'value'(_4989757, _5208379) {
				for (var _5981244, _4065388 = $(_4989757).attr('name'), _16350690 = $(_4989757).find('b'), _3038208 = _16350690.length, _3198382 = _3038208, _3248500 = 0; _3198382--;) _5981244 = _16350690[_3198382], 'active' === $(_5981244).attr('class') && (_3248500 = _3198382);
				if (1 === _5208379) {
					const _4989757 = _3248500 + 1 < _3038208 ? _3248500 + 1 : 0;
					$(_16350690[_3248500]).removeAttr('class'), $(_16350690[_4989757]).attr('class', 'active');
					const _5208379 = $(_16350690[_4989757]).attr('value');
					...
					$(_16350690[_3248500]).removeAttr('class');
					for (let _4989757, _5208379 = _3038208; _5208379--;)
						if (_4989757 = _16350690[_5208379], $(_4989757).attr('value') === this[_4065388]) {
			...
			'value'(_4989757, _4156470) {
				const _5588769 = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
					...
					_16350690 = $(_4989757).find('span'),
					_5428997 = _16350690[0],
					_1466059 = _16350690[1],
					_8780081 = $(_16350690[2]),
					_5821427 = ~~$(_5428997).attr('min'),
					_1772312 = ~~$(_5428997).attr('max'),
				...
				if (1 === _4156470 && _8237475 + _3892851 <= _1772312) {
					...
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - _5821427) / (_1772312 - _5821427)) + 'px'), _8780081.text(_4989757), this.saveTheme(_9532630, ~~_4989757);
				} else if (0 === _4156470 && _8237475 - _3892851 >= _5821427) {
					const _4989757 = _8237475 - _3892851;
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - _5821427) / (_1772312 - _5821427)) + 'px'), _8780081.text(_4989757), this.saveTheme(_9532630, ~~_4989757);
				} else if (2 === _4156470) {
					const _4989757 = this[_9532630];
					$(_5428997).attr('value', _4989757), $(_1466059).css('width', ~~(100 * (_4989757 - _5821427) / (_1772312 - _5821427)) + 'px'), _8780081.text(_4989757);
				} else if (3 === _4156470) {
			...
			'value'(_4989757) {
				...
				if ('custom' !== _4989757 && _15510291) {
					...
					for (const _4989757 in this.setDomValues(), _15510291.settings) _15510291.settings.hasOwnProperty(_4989757) && void 0 !== settings[_4989757] && (settings[_4989757] = _15510291.settings[_4989757], _1772312.set('settings', _4989757, settings[_4989757]));
	...
	const _5297403 = (() => {
		...
		_5451753 = new((() => {
			function _2325961() {
				plzsuckmydick(this, _2325961), this.loggedIn = false, this.token = '', this.button = $('#login-facebook'), this.options = {
			...
			return plzdsmd(_2325961, [{
				...
				'value'() {
					...
					$('#login-facebook').click(() => {
						...
						_2325961.logout();
					}), window.FB ? FB.init(this.options) : m.alert('Facebook', _4428048.current.notif.sdk_error);
				}
			}, {
				'key': 'init',
				'value'() {
				...
				'value'() {
					const _2325961 = this;
					return this.loggedIn ? void m.alert('Facebook', _4428048.current.notif.logged) : void(window.FB ? window.FB.login(_4701020 => {
				...
				'key': 'afterLogin',
				'value'(_2325961) {
					_2325961.authResponse ? (
							this.token = _2325961.authResponse.accessToken, _1772312.set('extras', 'fbToken', {
							'token': this.token,
						...
						Q.fbToken(), 
						m.alert('Facebook', _4428048.current.notif.login_success), 
						Q.freeCoins(1)
					) : 
					m.alert('Facebook', _4428048.current.notif.login_error);
				}
			}, {
				'key': 'logout',
				'value'() {
		...
		_4188507 = (() => {
			...
			return plzdsmd(_2033245, null, [{
				...
				'value'() {
					...
					_2999773 && (_2999773.expiry > Date.now() ? (this.token = _2999773.token, this.loggedIn = true, $('#login-google').addClass('active'), Q.googleToken(), m.alert('Google+', _4428048.current.notif.login_lastSession), Q.freeCoins(2)) : _1772312.set('extras', 'googleToken', false)), window.gapi ? window.gapi.load('auth2', () => {
					...
					}) : m.alert('Google+', _4428048.current.notif.sdk_error), $('#logout').click(() => {
						_2033245.logout();
					});
				}
			}, {
				...
				'value'(_2033245) {
					...
					}), this.loggedIn = true, $('#login-google').addClass('active'), Q.googleToken(), m.alert('Google+', _4428048.current.notif.login_success), Q.freeCoins(2)) : m.alert('Google+', _4428048.current.notif.login_error);
				}
			}, {
				'key': 'logout',
				'value'() {
					if (this.loggedIn) {
						gapi.auth2.getAuthInstance().signOut(), this.loggedIn = false, Q.triedCoins2 = false, this.token = null, $('#login-google').removeClass('active'), m.alert('Google+', _4428048.current.notif.logout), _1772312.set('extras', 'googleToken', false);
					}
				}
			}]), _2033245;
		})(),
		LEADERBOARD = (() => {
			...
			return plzdsmd(_4249194, null, [{
				'key': 'init',
				'value'() {
					this.html = this.getHTML(1), this.dataHTML = this.getHTML(2), this.playersAmount = 0, this.list = new Set(), this.div = $('#leaderboard-positions')[0], this.teamLB = $('#leaderboard-chart'), this.teamLBvisible = false, this.barsCss = document.createElement('style'), $('head').append(this.barsCss);
				}
			}, {
				'key': 'add',
	...
	S = new((() => {
		function _5998834() {
			plzsuckmydick(this, _5998834), this.canvas = $('#minimap-nodes')[0], this.ctx = this.canvas.getContext('2d'), this.size = 200, this.canvas.width = this.size, this.canvas.height = this.size, this.pi2 = 2 * Math.PI, this.ratio = 1, this.ctx.textAlign = 'center', this.ctx.textBaseline = 'bottom', this.ctx.lineWidth = 2;
		}
...
['size'] * this.ratio;
			...
			'value'() {
				...
				for (const player of se.teammates.values())
					if (player.isAlive && (2000 < le.time - player.lastUpdateAt || 0 === player.mass) && (player.isAlive = false), player.isAlive) {
						if (player.worldID === A.worldID || player.worldID === A.worldID2) {
							void 0;
						} else {
							player.animate();
							var _3741550 = player.mapX,
								_4715346 = player.mapY;
							_5998834.moveTo(_3741550 + 4, _4715346), _5998834.arc(_3741550, _4715346, 4, 0, this.pi2, false), 0 < player.nick.length && _5998834.fillText(player.nick, _3741550, _4715346 - 6);
						}
    ...
    T = new((() => {
		function _4088757() {
			plzsuckmydick(this, _4088757), this.fpsCount = 0, this.lastUpdateTime = 0, this.div = $('#stats-hud')[0], this.timeHud = $('#time-hud')[0], this.icon = {
		...
		return plzdsmd(_4325503, null, [{
			...
			'value'() {
				...
				$('#button-settings').click(() => {
					...
					_1772312.set('extras', 'region', $('#regions').val());
				}), $('#regions').val(_1772312.get('extras', 'region') || 'JP-Tokyo'), $('#gamemode').change(() => {
					_1772312.set('extras', 'gameMode', $('#gamemode').val()), _4325503.gMode = _1772312.get('extras', 'gameMode');
				}), $('#gamemode').val(_1772312.get('extras', 'gameMode') || ':party'), this.gMode = _1772312.get('extras', 'gameMode') || ':party', $('#minimap-show-1').click(() => {
				...
				}), _1772312.get('extras', 'openedChangelog') || $('#changelog').addClass('active'), $('#changelog').click(() => {
					_1772312.set('extras', 'openedChangelog', true), $('#changelog').removeClass('active');
				});
			}
		}, {
			'key': 'play',
			...
			'value'() {
				'on' === settings.targeting ? m.command('HSLO', _4428048.current.notif.targeting_on) : m.command('HSLO', _4428048.current.notif.targeting_off);
			}
		}, {
			'key': 'versionCheck',
			'value'() {
			...
			'key': 'showChangelog',
			'value'() {
				$('#anouncement').html(window['lang_' + _4428048.selected].updateHud.title + '<br>' + window['lang_' + _4428048.selected].updateHud.desc + (!localStorage.getItem('version').includes('5.3.2') ? '<br>' + window['lang_' + _4428048.selected].updateHud.versionChange : '') + '<hr>' + window['lang_' + _4428048.selected].updateHud.updateContent + '<br><hr><div align=\"right\">2019-11-26</div>'), $('#anouncement').fadeIn(250);
			}
		}]), _4325503;
    })(),
    ...
    I = new((() => {
		...
		return plzdsmd(_5246992, [{
			...
			'key': 'eatCell',
			'value'(idEater, idVictim, _7526961) {
				const cells = 1 === _7526961 ? this.cellsTab1 : 2 === _7526961 ? this.cellsTab2 : 3 === _7526961 && this.cellsTab3,
					playerCells = 1 === _7526961 ? this.myCellsTab1 : 2 === _7526961 ? this.myCellsTab2 : 3 === _7526961 && this.myCellsTab3,
					cellVictim = cells.get(idVictim),
					cellEater = cells.get(idEater);
				cellVictim && cellEater && (
					cellVictim.staticX = cellEater.staticX, 
					cellVictim.staticY = cellEater.staticY, 
					cellVictim.radius = cellVictim.animRadius, 
					cellVictim.lastUpdateTime = le.time, 
					cellVictim.fadeStartTime = le.time, 
					cellVictim.isMine && playerCells.delete(idVictim), 
					cells.delete(idVictim), 
					cellVictim.isFood || cells.set(idVictim + ':removed', cellVictim)
				);
			}
		}, {
			'key': 'removeCell',
			'value'(removedId, tabNum) {
				const _6245666 = 1 === tabNum ? this.cellsTab1 : 2 === tabNum ? this.cellsTab2 : 3 === tabNum && this.cellsTab3,
					_5546164 = 1 === tabNum ? this.myCellsTab1 : 2 === tabNum ? this.myCellsTab2 : 3 === tabNum && this.myCellsTab3,
					_16350690 = _6245666.get(removedId);
				_16350690 && (
					_16350690.isMine && _5546164.delete(removedId), 
					_6245666.delete(removedId), 
					_16350690.isFood || 'on' !== settings.eatAnimation || (
						_16350690.fadeStartTime = le.time, 
						_6245666.set(removedId + ':removed', _16350690)
						)
					);
			}
		}, {
			...
			'value'(_5246992, _4383652) {
				...
				if (_4383652 === 1) {
					this.bound.left > _5246992.staticX - _1772312.x + _5246992.radius && (this.bound.left = _5246992.staticX - _1772312.x + _5246992.radius)
					this.bound.right < _5246992.staticX - _1772312.x - _5246992.radius && (this.bound.right = _5246992.staticX - _1772312.x - _5246992.radius)
					this.bound.top > _5246992.staticY - _1772312.y + _5246992.radius && (this.bound.top = _5246992.staticY - _1772312.y + _5246992.radius)
					this.bound.bottom < _5246992.staticY - _1772312.y - _5246992.radius && (this.bound.bottom = _5246992.staticY - _1772312.y - _5246992.radius);
				} else if (_4383652 === 2) {
					this.bound2.left > _5246992.staticX - _1772312.x + _5246992.radius && (this.bound2.left = _5246992.staticX - _1772312.x + _5246992.radius)
					this.bound2.right < _5246992.staticX - _1772312.x - _5246992.radius && (this.bound2.right = _5246992.staticX - _1772312.x - _5246992.radius)
					this.bound2.top > _5246992.staticY - _1772312.y + _5246992.radius && (this.bound2.top = _5246992.staticY - _1772312.y + _5246992.radius)
					this.bound2.bottom < _5246992.staticY - _1772312.y - _5246992.radius && (this.bound2.bottom = _5246992.staticY - _1772312.y - _5246992.radius);
				} else if (_4383652 === 3) {
					this.bound3.left > _5246992.staticX - _1772312.x + _5246992.radius && (this.bound3.left = _5246992.staticX - _1772312.x + _5246992.radius)
					this.bound3.right < _5246992.staticX - _1772312.x - _5246992.radius && (this.bound3.right = _5246992.staticX - _1772312.x - _5246992.radius)
					this.bound3.top > _5246992.staticY - _1772312.y + _5246992.radius && (this.bound3.top = _5246992.staticY - _1772312.y + _5246992.radius)
					this.bound3.bottom < _5246992.staticY - _1772312.y - _5246992.radius && (this.bound3.bottom = _5246992.staticY - _1772312.y - _5246992.radius);
				}
			}
		}, {
			'key': 'isInView2',
    ...
    window.classI = I, M = (() => {
		...
		return plzdsmd(_13733995, [{
			...
			'value'() {
				...
				return _8204076 = 0 > _8204076 ? 0 : 1 < _8204076 ? 1 : _8204076,
				 this.x = this.animX + (this.staticX - this.animX) * _8204076, 
				 this.y = this.animY + (this.staticY - this.animY) * _8204076, 
				 this.animRadius = this._000308 + (this.radius - this._000308) * _8204076,
				  _8204076;
			}
		}, {
			'key': 'mass',
			...
			'value'() {
				if (this.isAlive) {
					...
					if (this.mass = 0, this.mass1 = 0, this.biggestPieceMass = 0, this.isAliveTab1)
						for (const _2546431 of I.myCellsTab1.values()) _2546431.animate(), _4127260 += _2546431.x / this.pieceCount, _5783189 += _2546431.y / this.pieceCount, playersize += _2546431.animRadius, this.mass1 += _2546431.staticMass, this.mass += _2546431.staticMass, this.biggestPieceMass < _2546431.staticMass && (this.biggestPieceMass = _2546431.staticMass);
					if (this.mass2 = 0, this.isAliveTab2) {
						const _1249945 = G.getOffset2;
						for (const _16350690 of I.myCellsTab2.values()) _16350690.animate(), _4738368 += (_16350690.x - _1249945.x) / this.pieceCount2, _5513006 += (_16350690.y - _1249945.y) / this.pieceCount2, playersize += _16350690.animRadius, this.mass2 += _16350690.staticMass, this.mass += _16350690.staticMass, this.biggestPieceMass < _16350690.staticMass && (this.biggestPieceMass = _16350690.staticMass);
					}
					...
					const zoomValue = Math.pow(Math.min(64 / playersize, 1), 0.4),
						zalupa2 = Math.max(window.innerWidth / 1920, window.innerHeight / 1080);
					L.autoZoomViewport = zoomValue * zalupa2;
				}
			}
		}, {
			'key': 'dead',
    ...
    L = new((() => {
		...
		return plzdsmd(_3417938, [{
			...
			'key': 'updateView',
			'value'() {
				let targetViewport = this.targetViewport;
				'on' === settings.autoZoom && (targetViewport *= this.autoZoomViewport), this.viewport += (targetViewport - this.viewport) / 8;
		...
		return plzdsmd(_4311880, [{
			...
			'value'() {
				if ('on' === settings.virusRange) {
					const ctx = re.ctx;
					ctx.globalAlpha = 0.1, ctx.fillStyle = '#ffffff', this.viruses.forEach(_5253006 => {
						...
						ctx.globalAlpha = 0.1 * _4524563, 
						ctx.beginPath(), 
						ctx.arc(_5253006.x - _16350690.x, _5253006.y - _16350690.y, _5253006.animRadius + 760, 0, re.pi2, true), 
						ctx.closePath(), 
						ctx.fill();
					}), ctx.globalAlpha = 1;
				}
		...
		return plzdsmd(_3741862, [{
			...
			'value'(_3741862) {
				...
				_1434097.crossOrigin = 'anonymous', _1434097.onload = () => {
					...
					_2458502.height = 512, 
					_16350690.beginPath(), 
					_16350690.arc(256, 256, 256, 0, _1140287.pi2, true), 
					_16350690.closePath(), 
					_16350690.clip(), 
					_16350690.drawImage(_1434097, 0, 0, 512, 512), 
					_1434097.onload = null, 
					_1434097.src = _2458502.toDataURL(), 
					_1140287.downloadedSkins.set(_3741862, _1434097);
				...
				for (let _5965524, _5057103 = 0; 5 > _5057103; _5057103++) {
					...
					for (let _4819163, _16350690 = 0; 5 > _16350690; _16350690++)
						if (_4819163 = this.letters[_5057103] + (_16350690 + 1), this.visible.has(_4819163)) {
							...
							_2000799.fillText('Ð“ÑžÐ’ÑœÐ²Ð‚ ', _5057103, _5965524);
						}
				}
			}
		}]), _2000799;
		...
		return plzdsmd(_3580490, [{
			...
			'value'(_3580490) {
				...
				for (_3580490.readUInt16(); !_3580490.endOfBuffer;) {
					...
					let _2650671 = 'unnamed cell',
						...
						_2400103 = false,
						_3372755 = false;
					1 & (_4303278 = _3580490.readUInt8()) && (_4929279 = _3580490.readUInt16()), 2 & _4303278 && (_2650671 = _3580490.readEscapedUTF8string()), 4 & _4303278 && (_16350690 = _3580490.readUInt32()), 8 & _4303278 && (_2400103 = true, _2650671 = A.nick), 16 & _4303278 && (_3372755 = true), (11 > _4929279 || _2400103) && LEADERBOARD.add(_2650671, _4929279, _2400103, _3372755, _16350690), LEADERBOARD.playersAmount = _4929279;
				}
				LEADERBOARD.update();
			}
		}, {
			...
			'value'(buffer) {
				...
				for (let flags, i = 0; !buffer.endOfBuffer;) {
					...
					(11 > i || isPlayer) && LEADERBOARD.add(name, i, isPlayer, isFriend, id),
					//console.log(name)
			...
			'value'(_3580490) {
				LEADERBOARD.clear(), _3580490.readUInt32(), LEADERBOARD.team(_3580490.readFloat32(), _3580490.readFloat32(), _3580490.readFloat32());
			}
		}, {
			'key': 'getReceiveKey',
			...
			'value'(_3580490, _3356034) {
				le.refreshTime();
				for (var _16157242 = 'on' === settings.eatAnimation, _3096924 = _3580490.readUInt16(); _3096924--;) {
    ...
    Q = new((() => {
		...
		return plzdsmd(_5337415, [{
			...
			'value'(_5337415, _2935028) {
				if(q.integrity == false) return q.send(_5337415.buffer, _2935028)
				if (1 === _2935028) {
			...
			'value'(_5337415) {
				...
				_3703912.setUint8(0, 254, true), _3703912.setUint16(1, 22, true), q.send(_3703912.buffer, _5337415);
			}
		}, {
			'key': 'handshake2',
			'value'(_5337415) {
    ...
    J = new((() => {
		function _7065734() {
			plzsuckmydick(this, _7065734), this.address = 'snez.dev:8080/ws?555', this.ogarWS1 = null, this.ogarWS2 = null;
		}
    ...
    _e = new((() => {
		...
		return plzdsmd(_4495393, [{
			...
			'value'() {
				...
				_4495393.writeUint8(0), 
				_4495393.writeUint16(401);
				...
				try {
					J.send(_4495393.buffer, 1),J.send(oppo.buffer, 1), J.send(_4495393.buffer, 2),J.send(oppo.buffer, 2);
				} catch (_5770151) {}
			}
		}, {
			'key': 'sendString',
	...
	re = new((() => {
		function _2668636() {
			const _2595915 = this;
			plzsuckmydick(this, _2668636), this.canvas = document.getElementById('canvas'), this.ctx = this.canvas.getContext('2d'), this.pi2 = 2 * Math.PI, this.commanderPoints = new Set(), this.maouImg = null, this.fantasyImg = null, this.resizeCanvas(), this.getMaouImg(), this.getEveryoneSkin(), this.getFantasyImg(), window.onresize = () => {
		...
		return plzdsmd(_2668636, [{
			...
			'value'() {
				const ctx = this.ctx,
					isOff = 'off' === settings.commander;
				ctx.strokeStyle = '#ffffff', ctx.lineWidth = 5;
				for (const wave of this.commanderPoints.values()) {
					const x = wave.x,
						y = wave.y,
						delta = le.time - wave.time;
					if (1250 < delta) this.commanderPoints.delete(wave);
					else if (!(isOff || 1 > delta)) {
						const alpha = 1000 * delta / 1250;
						ctx.globalAlpha = 333 < alpha ? (1000 - alpha) / 667 : 1;
						const _5193846 = ctx.createRadialGradient(x, y, 0.7 * alpha, x, y, alpha);
						_5193846.addColorStop(0, 'rgba(0,0,0,0)'), 
						_5193846.addColorStop(1, oe.commanderColor), 
						ctx.fillStyle = _5193846, 
						ctx.beginPath(), 
						ctx.arc(x, y, alpha, 0, this.pi2, true), 
						ctx.closePath(), 
						ctx.fill(), 
						ctx.stroke();
					}
