...
newButton.innerHTML = '<i class="fas fa-power-off"></i> View 2 <br> Auto Respawn <br> (Off) <span class="MuiTouchRipple-root css-w0pj6f"></span>';
...
newButton.addEventListener('click', () => {
    ...
    if (isCheckRespawnActive2) {
        ...
        newButton.innerHTML = '<i class="fas fa-redo-alt"></i> View 2 <br> Auto Respawn <br> (On) ';
        console.log('Botón ChangeV activado en vista 2');
        showMessage('[View 2]<br>Auto Respawn Activated', true);
    } else {
        newButton.style.backgroundColor = '#000000';
        newButton.innerHTML = '<i class="fas fa-power-off"></i> View 2 <br> Auto Respawn <br> (Off) ';
        console.log('Botón ChangeV desactivado en vista 2');
        showMessage('[View 2]<br>Auto Respawn Deactivated', false);
    }
});
